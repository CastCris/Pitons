    ...
    <main>
        <div class="centro">
            <section>
                    <div class="info">
                        <div>
                            <h2>Boas vindas à loja Píton!</h2>
                            <p>Como podemos te ajudarbg?</p>
                        </div>
                        <div>
                            <h3>Siga o criador!</h3>
                            <div>
                                <a href="https://github.com/CastCris">
                                    <img src="./src/img/octocat.png" alt="Gatû!" width="100px">
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <ul>
                                        ...
                                        <li>Ensino[inicial|inter.]</li>
                                        <li>Preço: <?php echo $valor['Snake2'][0]?></li>
                                    </ul>
                                    <div>
                                        <p>Originária de um exerimento cientifíco, o Python pode ser o professor ideal para jovens curiosos. Ele é como a professora chata, velha e mau agradecida do 7 ano-3º, porém o total oposto dos adjetivos negativos.</p> 
                                        <p>Pode ensinar o básico e o intermediário de forma certeira, aberto para novos alunos. Ela ensina tão bem, que muitos jovens já saiem por aí pensando saber mais que os alunos do professor Cê. Hahahah, mau sabe eles o que não sabem!</p>
                                    </div>
                                </div>
                                <div>
                                    <h4>Cê|M</h4>
                                    ...
                                    <div>
                                        <p>Resultante da seleção artificial feita pela Píton.SA, o Cê veio para inovar o mundo. Este, diferente do seu experimento Python, não é tão amigável aos iniciantes. Ele os aceita de bom grado,claro , porém, se perderem o ritmo da aprendizagem, vai deles correrem atrás disso. Este carinha é o ideal para quem ir além no mundo.</p>
                                    </div>
                                </div>
                                <div>
                                    <h4>Jajá|M</h4>
                                    ...
                                    <div>
                                        <p>Este nasceu para inovar o mundo, porém, diferentes de seus irmãos, Pyton e Cê, este seguiu o lado negro das Pítons. Nascido de um experimento de jovens estudantes da Píton.SA, o Jajá tinha um futuro promissor. Ele é bom da manipular objetos e fazer coisas quadráticas, entretanto pessímo de conta. Em sua cabeça 1+1='11', mas deixemos isso de lado</p>
                                        <p>O que levou ele ao lado negro das Pítons foi a sua determinação por objetos e hardware de uma forma toturosa ao humanos, ele aprendeu todos os caminhos nescessários para o suscesso mas foi corrompido pelo instito da complexidade. Bem, caso seja masoquista, essa píton foi feita para você!</p>
                                    </div>
                                </div>
                            </div>
                        <div>
                    ...
                    <div class="history">
                        ...
                        <div>
                            ...
                            <p> Ninguém, além do jovem Garçom, apareceu no funeral de Carlos. O garçom, chamado Robert, faria o que Carlos queria tanto fazer, uma loja de pítons. E assim fez! Carlos estaria muito orgulhoso do que ela se tranformou. Hoje, os valores das ações Pítons.SA se encontram na casa dos 4 dígitos, além da Loja Píton, mais tarde fundadora da Pítons.SA, ser a pioneira no aumento da população de pítons na natureza e em ambientes controlados, assim como tornou este animais menos agressivos, mais inteligentes, a ponto de entenderem o seu próprio nome, comandos e executar tarefas, e, para finalizar, a moeda piton se encontra negociável nos dias atuais, prometendo se a moeda do futuro!</p>
                        </div>
                    </div>
                </div>
                <div class="buttom">
                    <div class="dados">
                        <h3>Dados econômicos da Pítons.SA e outras filiais</h3>
                        <div>
                            <div>
                    ...
                    <div class="filais">
                        <h3>Píton.SA--Filiais</h3>
                        <div>
                            <div>
                                <h4>Pítons.SA</h4>
                                <p>Data de fundação: 26/02/2008</p>
